...
console.log(JSON.stringify({ exercises:exercises.length, muscles:muscles.length, tests:clinicalTests.length, goniometry:goniometry.length, reflexes:reflexes.length, scales:scales.length, neuro:exercises.filter(x=>x.kind==='neuro').length, functionalProblems:functionalProblems.length, discussionMeetings:discussionMeetings.length, commonComplaints:commonComplaints.length }, null, 2));
